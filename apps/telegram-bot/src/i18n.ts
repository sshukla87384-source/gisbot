...
const en: Dict = {
  ...
  b_orders: "📦 Orders", b_licenses: "🔑 My Licenses", b_wallet: "💳 Wallet", b_referral: "🎁 Refer & Earn",
  b_helpsupport: "🎫 Help & Support",
...
const hi: Dict = {
  ...
  b_orders: "📦 ऑर्डर", b_licenses: "🔑 मेरी लाइसेंस", b_wallet: "💳 वॉलेट", b_referral: "🎁 रेफर करें और कमाएं",
  b_helpsupport: "🎫 मदद और सहायता",
...
const ar: Dict = {
  ...
  b_orders: "📦 الطلبات", b_licenses: "🔑 تراخيصي", b_wallet: "💳 المحفظة", b_referral: "🎁 أحِل واربح",
  b_helpsupport: "🎫 المساعدة والدعم",
...
const zh: Dict = {
  ...
  b_orders: "📦 订单", b_licenses: "🔑 我的许可", b_wallet: "💳 钱包", b_referral: "🎁 推荐赚钱",
  b_helpsupport: "🎫 帮助与客服",
