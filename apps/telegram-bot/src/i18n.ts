...
const en: Dict = {
  ...
  b_shopnow: "🛍 Browse Products",
  b_shop: "🛍 Shop", b_categories: "📂 Categories", b_search: "🔍 Search", b_cart: "🛒 Cart",
  b_orders: "📜 Order history", b_licenses: "🧾 My Orders", b_wallet: "💳 Wallet", b_referral: "👥 Referral",
  b_support: "🆘 Help & Support", b_language: "🌐 Language", b_help: "❓ Help", b_developer: "🧑‍💻 Developer API",
...
const hi: Dict = {
  ...
  b_orders: "📜 ऑर्डर इतिहास", b_licenses: "🧾 मेरे ऑर्डर", b_wallet: "💳 वॉलेट", b_referral: "👥 रेफरल",
  b_support: "🆘 मदद और सहायता", b_language: "🌐 भाषा", b_help: "❓ मदद", b_developer: "🧑‍💻 डेवलपर API",
...
const ar: Dict = {
  ...
  b_orders: "📜 سجل الطلبات", b_licenses: "🧾 طلباتي", b_wallet: "💳 المحفظة", b_referral: "👥 الإحالة",
  b_support: "🆘 المساعدة والدعم", b_language: "🌐 اللغة", b_help: "❓ مساعدة", b_developer: "🧑‍💻 واجهة المطور",
...
const zh: Dict = {
  ...
  b_orders: "📜 订单历史", b_licenses: "🧾 我的订单", b_wallet: "💳 钱包", b_referral: "👥 推荐",
  b_support: "🆘 帮助与支持", b_language: "🌐 语言", b_help: "❓ 帮助", b_developer: "🧑‍💻 开发者 API",
